...
Problem:
    ...
    However, after a couple days of coding you discover that there
    is one important feature that this IDE lacks: it cannot convert
...
def solution(code: str, x: int) -> str:
    return code.replace('\t', x * ' ')


print(solution('\treturn False'))